...
from .PyWeb import PyWebApp
from threader import PyThread, Primitive, synchronized
...
class CleanerThread(PyThread):

    def __init__(self, storage, data_root,
                        cleanup_frequency,
                        session_timeout
        ):
...
class SessionStorage(Primitive):
    ...
    def __init__(self, root_path, 
        ...
        self.CleanUpFrequency = cleanup_frequency
        self.SessionTimeout = session_timeout
        self.CleanerThread = CleanerThread(self, root_path, self.CleanUpFrequency, self.SessionTimeout)
...
class PyWebSessionApp(PyWebApp):
    ...
    def __call__(self, environ, start_response):
        ...
        output = PyWebApp.__call__(self, environ, my_start_response)
